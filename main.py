...
# files = LevyTDMS(r"G:\.shortcut-targets-by-id\0B8-gGFa6hkR4XzJJMDlqZXVKRk0\ansom\Data\THz 1\Pubudu's Data\dmicro_measurements\thorlabs_40x.log\14 - 20250604_CtrlExp_UnequalDispersion") 
# files = LevyTDMS(r"G:\.shortcut-targets-by-id\0B8-gGFa6hkR4XzJJMDlqZXVKRk0\ansom\Data\THz 1\SA40653C.20250526\32 - 20250709_CtrlExp_50K_100mBias") 
# files = LevyTDMS(r"G:\.shortcut-targets-by-id\0B8-gGFa6hkR4XzJJMDlqZXVKRk0\ansom\Data\THz 1\SA40653C.20250526\41 - 20250716_CtrlExp_110K_100mBias") 
files = LevyTDMS(r"G:\.shortcut-targets-by-id\0B8-gGFa6hkR4XzJJMDlqZXVKRk0\ansom\Data\THz 1\SA40653C.20250526\45 - 20250716_CtrlExp_200K_100mBias") 
...
filtered_data = files.apply_frequency_filter(
    ...
    signal_key='Ch3_y',
    delay_key='Delay',
    bands_THz=[(0, 100), (350, 450), (700, 900)]
)
